...
sequenceDiagram
    ...
    activate server
    Note right of browser: Pyyntö sisältää JSON-muotoisen uuden muistiinpanon, johon kuuluu sekä sisältö (content) että aikaleima (date): {"content": "SPA", "date": "2024-07-23T16:10:43.687Z"}
