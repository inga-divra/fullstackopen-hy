...
Note right of browser: Käyttäjä kirjoittaa tekstin tekstikentään ja paina 'Save'- näppäintä
...
Note right of browser: Pyyntöön liitetty headeri Content-Type kertoo palvelimelle, että data on JSON-muotoista : Content-Type:
